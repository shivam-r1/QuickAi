...
import { CreativeCommons, Gem, Sparkles } from "lucide-react";
...

      {
        loading ? (
          <div className="flex justify-center items-center h-3/4 ">
            <div className="h-11 w-11 my-1 rounded-full border-3 border-purple-500 border-t-transparent animate-spin"></div>
          </div>
        ) : (
