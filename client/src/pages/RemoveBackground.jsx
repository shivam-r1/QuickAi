  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button
          disabled={loading}
          className="w-full bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white py-2 px-4 mt-6 rounded flex items-center justify-center gap-2 text-sm rounded-lg cursor-pointer"
        >
          {loading ? (
